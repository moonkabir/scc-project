    ...
    <div class="row">
		...
		<div class="col-lg-9 doctor-specialization">
			<div class="admin-header d-flex justify-content-between">
				<h2>ADMIN | STUDENT DELETE ACCOUNT</h2>
            </div>
            <section class="login">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 login-form-section">
                            <div class="box-login admin-registration">
                                <form class="form-login" method="post">
                                    <fieldset>
                                        <p>Please enter id for delete<br /></p>
                                        <div class="form-group">
                                            <span class="input-icon">
                                                <input type="text" class="form-control" name="studentid" placeholder="ID">
                                            </span>
                                        </div>
                                    ...
                                    <input type="hidden" name="action" value="admin-student-delete">
                                </form>
                            </div>
                        </div>
                    </div>
